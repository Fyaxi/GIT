<?php
/**
 * ContratoList TSession::getValue('unit_database')
 *
 * @version    2.0
...
class ContratoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $tipo_contrato_id = new TDBUniqueSearch('tipo_contrato_id', TSession::getValue('unit_database'), 'TipoContrato', 'id', 'nome');
        ...
        $this->form->addActionLink('<b>Agendar Festa</b>', new TAction(['ContratoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        */
        ...
        $panel = new TPanelGroup('<small>relação de festas</small>', 'white');
