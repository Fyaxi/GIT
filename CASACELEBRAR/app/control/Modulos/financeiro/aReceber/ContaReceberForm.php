...
class ContaReceberForm extends TPage
{
    ...
    function __construct()
    {
        ...
        // add the fields
        $this->form->addFields( [ new TLabel('Recebimento N°') ], [ $id ] );
        ...
        $this->form->addFields( [ new TLabel('Forma Recebimento') ], [ $forma_recebimento ] );
        $this->form->addFields( [ new TLabel('Valor Total') ], [ $valor_total ] );
        $this->form->addFields( [ new TLabel('Desconto') ],[ $desconto ]);
        $this->form->addFields( [ new TLabel('Valor a Receber') ], [ $valor ] );
        ...
        $forma_recebimento->addValidation('Forma Recebimento', new TRequiredValidator);
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            {
                ContaReceberPg::where('recebimento_id', '=', $object->id)->delete();
