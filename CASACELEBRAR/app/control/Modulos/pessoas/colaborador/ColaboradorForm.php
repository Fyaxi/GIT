...
class ColaboradorForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $row = $subform->addFields( [ new TLabel('<br>Papéis <span style="color:red">*</span>'),  $papeis_id ],
                                       [ new TLabel('<br>Grupo <span style="color:red">*</span>'),  $grupo_id ] );
        $row->layout = ['col-sm-6', 'col-sm-6'];
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            PessoaPapel::where('colaborador_id', '=', $object->id)->delete();
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object->papeis_id = PessoaPapel::where('colaborador_id', '=', $object->id)->getIndexedArray('papel_id');
