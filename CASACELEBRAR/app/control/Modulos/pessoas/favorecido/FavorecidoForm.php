...
class FavorecidoForm extends TWindow
{
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            PessoaPapel::where('favorecido_id', '=', $object->id)->delete();
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object->papeis_id = PessoaPapel::where('favorecido_id', '=', $object->id)->getIndexedArray('papel_id');
    ...
    public static function onChangeEstado($param)
    {
        try
        {
            ...
            if (!empty($param['estado_id']))
            {
                ...
                TDBCombo::reloadFromModel('form_Favorecido', 'cidade_id', TSession::getValue('unit_database'), 'Cidade', 'id', '{nome} ({id})', 'nome', $criteria, TRUE);
            }
            else
            {
